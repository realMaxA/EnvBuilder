...
Процедура НастроитьКомандыПриложения(Знач Приложение) Экспорт
	...
	Приложение.ДобавитьКоманду("list",             "КомандаList",                "Выводит список настроенных окружений");
	Приложение.ДобавитьКоманду("deploy",           "КомандаDeploy",              "Выполняет развертывание окружений");
	//...
